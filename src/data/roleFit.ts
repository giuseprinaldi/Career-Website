// The "Role Fit" section: the core work of a Scrum Master paired with concrete past-tense
// evidence from Joe's résumé. Responsibilities are paraphrased (not lifted verbatim from any
// single job posting) and framed as "here's where I've already done this," not as claims of
// current fluency in ceremonies/tools he hasn't run yet.
...
export const roleFit: RoleFitItem[] = [
  {
    responsibility: "Keep the team anchored to Lean-Agile principles and the flow of value.",
    evidence:
  ...
  {
    responsibility: "Facilitate the team's ceremonies and planning cadence.",
    evidence:
  ...
  {
    responsibility: "Surface and clear impediments so delivery keeps moving.",
    evidence:
  ...
  {
    responsibility: "Partner with the Product Owner to keep the backlog refined and prioritized.",
    evidence:
  ...
  {
    responsibility: "Hold the line on acceptance criteria and a real Definition of Done.",
    evidence:
  ...
  {
    responsibility: "Make delivery transparent with the team's flow and velocity metrics.",
    evidence:
  ...
  {
    responsibility: "Break big, fuzzy initiatives into well-sized, ready-to-build work.",
    evidence:
  ...
  {
    responsibility: "Run retrospectives that turn into tracked, real improvements.",
    evidence:
  ...
  {
    responsibility: "Keep process documented well enough to stand up to an audit.",
    evidence:
